      ...
      <div className="app__about-container">
        <div className="app__about-container_text">
          ...
          <p>
            ...
            Results-driven Full Stack Developer with 8 years of experience,
            known for delivering high-quality, scalable web applications that
            improve user experiences and business outcomes. Trusted for solving
            complex problems with innovative solutions, and for leading projects
            from concept to deployment. Recognized for a strong balance of
            technical expertise and creative thinking to drive seamless,
            impactful results..
          </p>
        </div>
